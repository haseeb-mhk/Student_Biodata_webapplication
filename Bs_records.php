...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Bachelors Students Records</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item active">Bachelors Students Records</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="card-body">
              ...
              <table class="table datatable"  border="1">
                ...
                <thead>
                    ...
                    <tbody>
                      <?php $query=mysqli_query($link,"SELECT * FROM student
WHERE Discipline LIKE 'B%'; ");
                      $cnt=1;
